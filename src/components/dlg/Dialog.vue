      ...
      <transition name="dialog-scale" appear>
        <div
          ...
          <button @click="handleCancel"
            class="absolute cursor-pointer top-0 right-0 text-gray-500 dark:text-gray-400 hover:text-gray-700 dark:hover:text-gray-200 text-2xl font-bold transition-colors focus:outline-none focus:ring-2 focus:ring-primary-500 rounded-full p-1"
            aria-label="Close">
            &times;
          </button>
