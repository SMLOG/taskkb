<template>
    <div class="max-w-md mx-2">
      <div class="flex space-x-2">
        <button @click="share" class="bg-blue-500 text-white px-2 py-1 text-sm rounded hover:bg-blue-600 flex items-center">
        ...
        <button @click="showProfile" class="bg-blue-500 text-white p-1 rounded-full hover:bg-blue-600 flex items-center justify-center w-8 h-8">
