    ...
    <div
      ...
      <div class="flex justify-between">
        <button @click="addNewUser"
          class="bg-gray-200 dark:bg-gray-700 hover:bg-gray-300 dark:hover:bg-gray-600 text-gray-800 dark:text-white py-2 px-4 rounded border border-gray-300 dark:border-gray-600">Add
          account</button>
        <button @click="$emit('sign-out')"
          class="bg-gray-200 dark:bg-gray-700 hover:bg-gray-300 dark:hover:bg-gray-600 text-gray-800 dark:text-white py-2 px-4 rounded border border-gray-300 dark:border-gray-600">Sign
          out</button>
      </div>
    </div>
  </div>
