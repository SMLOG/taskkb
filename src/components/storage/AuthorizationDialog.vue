<template>
  <div class="fixed inset-0 z-50 flex items-center justify-center bg-black/40 dark:bg-black/60 backdrop-blur-sm transition-all duration-300">
    <div class="bg-white dark:bg-gray-800 p-6 rounded-lg shadow-lg text-center relative border border-gray-200 dark:border-gray-700">
      ...
      <p class="mb-4 text-gray-600 dark:text-gray-300">Authorize this app in OneDrive:</p>

      <GoogleDrivePicker class="inline-block px-4 py-2 bg-blue-600 text-white rounded hover:bg-blue-700 dark:bg-blue-500 dark:hover:bg-blue-600 transition-colors">
        Authorize
      </GoogleDrivePicker>
