<template>
  <div class="max-w-md mx-2 mt-1 relative">
    <div class="flex items-center space-x-2">
      <!-- Menu Button -->
      <div>
        <a href="https://www.buymeacoffee.com/alex_wang" target="_blank"><img
            src="https://cdn.buymeacoffee.com/buttons/v2/default-yellow.png" alt="Buy Me A Coffee"
            style="height: 28px !important;width: 100px !important;"></a>
      </div>
      <button ref="showMenu" @click="showDropDownMenuItems" aria-label="Open menu"
      ...
      <!-- Share Button -->
      <button @click="handleShare" aria-label="Share content"
      ...
      <!-- Profile Button -->
      <button ref="showProfileButton" @click="toggleShowProfile" aria-label="Toggle profile"
    ...
    <!-- Dropdown Menu -->
    <MenuItems v-if="isMenuVisible" :showButton="showMenu" @close="isMenuVisible = false"
      @keydown.escape="isMenuVisible = false" />

    <!-- Profile Panel -->
    <Profile v-if="isProfileVisible" :showProfileButton="showProfileButton" @close="isProfileVisible = false"
