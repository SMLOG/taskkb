    ...
    <div class="flex items-center space-x-2">
      ...
      >
        <svg width="12" height="12" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
          <circle data-v-8a269fda="" cx="4" cy="12" r="2" fill="currentColor"></circle>
          <circle data-v-8a269fda="" cx="12" cy="12" r="2" fill="currentColor"></circle>
          <circle data-v-8a269fda="" cx="20" cy="12" r="2" fill="currentColor"></circle>
        </svg>
      </button>
